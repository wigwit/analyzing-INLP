...
\begin{table*}[ht]
    ...
    \begin{tabular}{llll}
    \hline
    \textbf{Duty} & \textbf{Details} & \textbf{Who is in Charge} \\
    \hline
    \multirow{5}{*}{Coding the experiment} & data preprocessing & Qingxia \\
    ...
    \hline
    \multirow{2}{*}{Presenting related topic} & \multirow{2}{*}{presenting INLP method} & \multirow{2}{*}{Lindsay \& Gladys} \\
    & & \\
    \hline
    \multirow{3}{*}{Writing paper} & method section  & Lindsay \\
