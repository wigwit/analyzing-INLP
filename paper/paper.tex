...
To investigate the compositionality of semantics space and syntactic space, we also calculated the average cosine simliarity scores between embeddings in table \ref{sim}.
...
\begin{table}[h]
    \centering
    \begin{tabular}{p{4cm}p{3cm}}
        expression & similarity score\\ \hline 
